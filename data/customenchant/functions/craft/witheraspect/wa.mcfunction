tag @s add Craftwa
execute at @e[tag=Craftwa] run summon item ~ ~ ~ {Item:{id:"minecraft:golden_sword",Count:1b,tag:{Customtag:"wa",Damage:0,display:{Lore:['{"text":"ウィザー付与","color":"light_purple"}']}}}}
