tag @s add Craftnth
execute at @e[tag=Craftnth] run summon item ~ ~ ~ {Item:{id:"minecraft:diamond_chestplate",Count:1b,tag:{Customtag:"nth",Damage:0,display:{Lore:['{"text":"腹減り無効","color":"light_purple"}']}}}}
