...
execute at @e[tag=CraftTNTWalker] run summon item ~ ~ ~ {Item:{id:"minecraft:diamond_boots",Count:1b,tag:{Customtag:"tntw",Damage:0,display:{Lore:['{"text":"TNT歩行者","color":"light_purple"}']}}}}
