tag @s add Craftdm
execute at @e[tag=Craftdm] run summon item ~ ~ ~ {Item:{id:"minecraft:iron_boots",Count:1b,tag:{Customtag:"dm",Damage:0,display:{Lore:['{"text":"Dirty Man","color":"light_purple"}']}}}}
