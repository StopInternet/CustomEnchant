...
execute at @e[tag=CraftRabbit] run summon item ~ ~ ~ {Item:{id:"minecraft:diamond_boots",Count:1b,tag:{Customtag:"rt",Damage:0,display:{Lore:['{"text":"Rabbit","color":"light_purple"}']}}}}
